...
'hello-world': { 
name: "0. Hello World",
code: `( This is a comment, and is ignored by the assembler.
...
'stack': { 
name: "1. Stack",
code: `( The Uxn virtual machine has a working stack of 256 bytes.
...
'numbers': { 
name: "2. Numbers",
code: `( A literal is a number to be pushed to the stack,
...
'functions': { 
name: "3. Functions",
code: `( Function labels are followed by a comment that explains
...
'variables': { 
name: "4. Variables",
code: `( The program location can be moved to create labels of different values,
  but must always be returned to 100, which is where all Uxn programs begin. )

|0000               ( Move program location to Zero-page )

    @zep8 $1       ( Allocate a byte of space )
    @zep16 $2      ( Allocate a short of space )

|0100               ( Move program location to Reset )
...
'if-else': { 
name: "5. If/else",
code: `( Immediate conditional jumps in Uxntal is done
...
'loop': { 
name: "6. Loop",
code: `( Basic loops are done by pushing a limit and an iterator
...
'enums---structs': { 
name: "7. Enums & Structs",
code: `( Programs can utilize up to ff00 of memory,
...
'macros': { 
name: "8. Macros",
code: `( A macro is an inline function, but it must be created before. )
...
'objects': { 
name: "9. Objects",
code: `( Uxntal objects are statically allocated data-structures
...
'debugging': { 
name: "10. Debugging",
code: `( The stack states can be printed at any point during
